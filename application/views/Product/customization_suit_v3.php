                    ...
                    <div class="col-sm-5 large-detail shirtcontainer  " >
                        ...
                        <div class="col-sm-12 col-xs-12"  style="padding: 0">
                            <div class="tab-content">
                                ...
                                <canvas id="customCanvas1" class="fixpos animated" width="600" height="600" style="zoom:80%" ></canvas>

                                <!--<canvas id="jacketstyleoverlay" class="fixpos animated" width="600" height="600" style="zoom:80%" ></canvas>-->

                                <canvas id="jacketstylel" class="fixpos animated" width="600" height="600" style="zoom:80%" ></canvas>


                                <canvas id="jacketstyler" class="fixpos animated" width="600" height="600" style="zoom:80%" ></canvas>



<!--<canvas id="customCanvas4" class="fixpos animated" width="600" height="600" style="zoom:80%" ></canvas>-->
<!--<canvas id="customCanvas5" class="fixpos animated" width="600" height="600" style="zoom:80%" ></canvas>-->
                                <img src="" class="fixpos animated" >
...
<script>
    ...
    var customeimageserver = "<?php echo custome_image_server; ?>";
</script>

<!--angular controllers-->
<script src="<?php echo base_url(); ?>assets/theme2/angular/ng-suitcustomization3.js"></script>
